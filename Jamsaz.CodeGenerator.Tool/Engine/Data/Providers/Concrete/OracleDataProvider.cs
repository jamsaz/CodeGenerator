...
{
    public class OracleDataProvider : IReadableDataProvider<IQueryable<Models.Data>>, IDataProvider
    {
        private JObject _config;
        public OracleDataProvider(IConfigurationManager configurationManager)
        {
