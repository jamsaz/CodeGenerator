...
{
    public class CsvDataProvider : IReadableDataProvider<IQueryable<Models.Data>>, IDataProvider
    {
        private JObject _config;
        public CsvDataProvider(IConfigurationManager configurationManager)
        {
